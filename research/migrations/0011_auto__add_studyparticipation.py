...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StudyParticipation'
        db.create_table(u'research_studyparticipation', (
            ...
            ('study_id', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'research', ['StudyParticipation'])


    def backwards(self, orm):
        # Deleting model 'StudyParticipation'
        db.delete_table(u'research_studyparticipation')
    ...
    models = {
        ...
        u'research.studyparticipation': {
            'Meta': {'object_name': 'StudyParticipation'},
            'consistency_token': ('django.db.models.fields.CharField', [], {'max_length': '8'}),
            'episode': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['opal.Episode']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'study_id': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        }
    }
