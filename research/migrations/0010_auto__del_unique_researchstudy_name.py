...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ResearchStudy', fields ['name']
        db.delete_unique(u'research_researchstudy', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'ResearchStudy', fields ['name']
        db.create_unique(u'research_researchstudy', ['name'])
