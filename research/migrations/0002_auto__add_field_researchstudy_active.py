...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResearchStudy.active'
        db.add_column(u'research_researchstudy', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResearchStudy.active'
        db.delete_column(u'research_researchstudy', 'active')
